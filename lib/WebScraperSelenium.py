...
class WebScraperSelenium():
    ...
    def __init__(self):
        ...
        self.__datos = cargarFicheroDiccionario(ruta_relativa('archivos/configuracion.txt'),
                                                ';')  # Contiene el diccionario con la configuración
        self.__acciones = cargaExcelVariable(ruta_relativa('archivos/Plantilla.xlsx'),
                                             'str')  # Contiene el dataframe con las acciones
        self.__variables = {}
